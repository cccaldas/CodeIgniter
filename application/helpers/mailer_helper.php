...
function mailer_sender_send($to, $toName, $subject, $message) {
	$mailer = new PHPMailer();
	$mailer->IsSMTP();
	$mailer->Host     = "smtp.domain.com";
	$mailer->From     = "sender@domain.com";
	$mailer->FromName = "Sender";
	$mailer->Username = "sender@domain.com";
...
function mailer_get_template($template, $data) {
	$template = file_get_contents(APPPATH . "views/email/" . $template);
